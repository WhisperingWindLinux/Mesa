...
INSTANTIATE_TEST_SUITE_P(LoadStoreVariants, DisasmTest,
   testing::Values(
      ...
      disasm_state{ {0x00861033, 0x15400d04, 0x100efe40, 0x7085860f}, "store.denorm.local t6.x___, t0.yyyy, 4092, 99.000000\n", FLAG_FAILING_ASM},
      disasm_state{ {0x07800033, 0x00200c34, 0x80000050, 0x00390018}, "store.denorm.u32.ls6 mem, u0.xxxx, t0.xxxx, t1.xyzw\n"},
      disasm_state{ {0x01011033, 0x00200c04, 0x90000040, 0x7800000f}, "store.denorm.u32  t1._y__, t0.xxxx, 0, 0\n", FLAG_FAILING_ASM}
   )
);
// clang-format on
