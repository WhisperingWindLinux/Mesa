...
FreedrenoDriver::setup_a7xx_counters()
{
   ...
   struct {
      ...
      unsigned number_of_usptp;
      unsigned number_of_alus_per_usptp;
   } hardware = {
      .number_of_sp = 6,
      .number_of_usptp = 2,
   ...
   counter("ALU / Fragment", Counter::Units::None, [=]() {
          ...
          */
         /* TODO: exact formula: (FULL_ALU_INST + HALF_ALU_INST / 2) / PERF_SP_QUADS
          *   => how would PERF_SP_PIXELS translate to PERF_SP_QUADS??
          */
   ...
   counter("EFU / Fragment", Counter::Units::None, [=]() {
          ...
          * KGSL_PERFCOUNTER_GROUP_SP::COUNTABLE_99 = PERF_SP_QUADS -- we use PERF_SP_PIXELS instead
          */
         /* TODO: exact formula: PERF_SP_FS_STAGE_EFU_INSTRUCTIONS / PERF_SP_QUADS
          *   => how would PERF_SP_PIXELS translate to PERF_SP_QUADS??
          */
   ...
   counter("% Shader ALU Capacity Utilized", Counter::Units::Percent, [=]() {
         ...
         int64_t denominator = PERF_SP_BUSY_CYCLES * hardware.number_of_alus_per_usptp;
   ...
   counter("% Shaders Busy", Counter::Units::Percent, [=]() {
         ...
         return percent(numerator, hardware.number_of_sp * hardware.number_of_usptp * PERF_RBBM_STATUS_MASKED);
      }
   );
   counter("% Shaders Stalled", Counter::Units::Percent, [=]() {
          ...
          * KGSL_PERFCOUNTER_GROUP_RBBM::COUNTABLE_6 = PERF_RBBM_STATUS_MASKED
          */
         return percent(PERF_SP_NON_EXECUTION_CYCLES, hardware.number_of_sp * hardware.number_of_usptp * PERF_RBBM_STATUS_MASKED);
      }
   );
   counter("% Texture Pipes Busy", Counter::Units::Percent, [=]() {
          ...
          * KGSL_PERFCOUNTER_GROUP_RBBM::COUNTABLE_6 = PERF_RBBM_STATUS_MASKED
          */
         return percent(PERF_TP_BUSY_CYCLES, hardware.number_of_sp * hardware.number_of_usptp * PERF_RBBM_STATUS_MASKED);
      }
   );
   counter("Textures / Fragment", Counter::Units::None, [=]() {
   ...
   counter("% Wave Context Occupancy", Counter::Units::Percent, [=]() {
          ...
          */
         // FIXME: Disabled due to overuse of SP counters
         // return (PERF_SP_WAVE_CONTEXTS / PERF_SP_WAVE_CONTEXT_CYCLES) / hardware.number_of_execution_wave_slots_per_sp;
         return 42;
      }
   );
   ...
   counter("% Texture Fetch Stall", Counter::Units::Percent, [=]() {
          ...
          * KGSL_PERFCOUNTER_GROUP_RBBM::COUNTABLE_6 = PERF_RBBM_STATUS_MASKED
          */
         return percent(cbSum(PERF_SP_STALL_CYCLES_TP), hardware.number_of_sp * hardware.number_of_usptp * PERF_RBBM_STATUS_MASKED);
      }
   );
   counter("% Texture L1 Miss", Counter::Units::Percent, [=]() {
